    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
           <span className="text-green-600">Trash2Treasure</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
          A DIGITAL REVELOUTION TOWARDS SMARTER WASTE DISPOSAL
        </p>
        <div className="flex items-center justify-center gap-8 mb-5 text-center">
        <img 
         src="/althaf Final logo (1).png" 
        ...
        <p className="text-2xl font-bold text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
          DEVELOPED BY LEO CLUB OF COLOMBO WATERS MEET
        </p>
